...
class QuotationsController extends BaseController
{
    ...
    public function store(Request $request)
    {
     ...
     //------------ store_quotation_custom -------------\\

     public function store_quotation_custom(Request $request)
     {
         $this->authorizeForUser($request->user('api'), 'create', Quotation::class);
         ...
         \DB::transaction(function () use ($request) {
             ...
             $order->zone_1 = $request->zone_1;
             $order->zone_2 = $request->zone_2;
             $order->zone_3 = $request->zone_3;
             $order->zone_4 = $request->zone_4;
             $order->zone_5 = $request->zone_5;
             $order->zone_6 = $request->zone_6;
             $order->zone_7 = $request->zone_7;
             $order->zone_8 = $request->zone_8;
             $order->zone_9 = $request->zone_9;
             $order->zone_10 = $request->zone_10;
             $order->zone_11 = $request->zone_11;
             $order->zone_12 = $request->zone_12;
             $order->zone_13 = $request->zone_13;
             $order->zone_14 = $request->zone_14;
             $order->zone_15 = $request->zone_15;
             $order->zone_16 = $request->zone_16;
    ...
    public function update(Request $request, $id)
    {
        ...
        \DB::transaction(function () use ($request, $id) {
            ...
            $current_Quotation->update([
                ...
                'zone_1' => $request['zone_1'],
                'zone_2' => $request['zone_2'],
                'zone_3' => $request['zone_3'],
                'zone_4' => $request['zone_4'],
                'zone_5' => $request['zone_5'],
                'zone_6' => $request['zone_6'],
                'zone_7' => $request['zone_7'],
                'zone_8' => $request['zone_8'],
                'zone_9' => $request['zone_9'],
                'zone_10' => $request['zone_10'],
                'zone_11' => $request['zone_11'],
                'zone_12' => $request['zone_12'],
                'zone_13' => $request['zone_13'],
                'zone_14' => $request['zone_14'],
                'zone_15' => $request['zone_15'],
                'zone_16' => $request['zone_16'],
            ]);
    ...
    public function show(Request $request, $id)
    {
        ...
        $quote['is_custom'] = $quotation_data->is_custom?'yes':'no';

        $quote['zone_1'] = $quotation_data->zone_1;
        $quote['zone_2'] = $quotation_data->zone_2;
        $quote['zone_3'] = $quotation_data->zone_3;
        $quote['zone_4'] = $quotation_data->zone_4;
        $quote['zone_5'] = $quotation_data->zone_5;
        $quote['zone_6'] = $quotation_data->zone_6;
        $quote['zone_7'] = $quotation_data->zone_7;
        $quote['zone_8'] = $quotation_data->zone_8;
        $quote['zone_9'] = $quotation_data->zone_9;
        $quote['zone_10'] = $quotation_data->zone_10;
        $quote['zone_11'] = $quotation_data->zone_11;
        $quote['zone_12'] = $quotation_data->zone_12;
        $quote['zone_13'] = $quotation_data->zone_13;
        $quote['zone_14'] = $quotation_data->zone_14;
        $quote['zone_15'] = $quotation_data->zone_15;
        $quote['zone_16'] = $quotation_data->zone_16;
    ...
    public function Quotation_pdf(Request $request, $id)
    {
        ...
        $quote['is_custom'] = $Quotation->is_custom?'yes':'no';

        // $quote['zone_1'] = $Quotation->zone_1;
        // $quote['zone_2'] = $Quotation->zone_2;
        // $quote['zone_3'] = $Quotation->zone_3;
        // $quote['zone_4'] = $Quotation->zone_4;
        // $quote['zone_5'] = $Quotation->zone_5;
        // $quote['zone_6'] = $Quotation->zone_6;
        // $quote['zone_7'] = $Quotation->zone_7;
        // $quote['zone_8'] = $Quotation->zone_8;
        // $quote['zone_9'] = $Quotation->zone_9;
        // $quote['zone_10'] = $Quotation->zone_10;
        // $quote['zone_11'] = $Quotation->zone_11;
        // $quote['zone_12'] = $Quotation->zone_12;
        // $quote['zone_13'] = $Quotation->zone_13;
        // $quote['zone_14'] = $Quotation->zone_14;
        // $quote['zone_15'] = $Quotation->zone_15;
        // $quote['zone_16'] = $Quotation->zone_16;

        // Loop through the zones and add non-empty ones to the $zones array
        $zones = [];
        for ($i = 1; $i <= 16; $i++) {
            $zoneKey = 'zone_' . $i;
            $zoneValue = $Quotation->$zoneKey;
        
            if (!empty($zoneValue) && $zoneValue != 'null') {
                $zones[$i] = $zoneValue; // Add key-value pair to $zones array
            }
        }

        // Count the non-empty zones
    ...
    public function SendEmail(Request $request)
    {
        ...
        $email['Ref'] = $quotation_number;

        $pdf = $this->Quotation_pdf($request, $request->id);

        $this->Set_config_mail(); 

        $mail = Mail::to($receiver_email)->send(new QuotationMail($email, $pdf));
