        ...
        <div class="invoice-print">
          ...
          <b-row class="mt-3">
            ...
            <div class="col-md-4 mt-4">
              <table class="table table-bordered table-sm" v-if="quote.is_custom == 'yes'">
                <tbody>
                  <tr v-if="quote.zone_1 != '' && quote.zone_1 != 'null' && quote.zone_1 != null">
                    <td class="bold">Zone 1</td>
                    <td>{{quote.zone_1}}</td>
                  </tr>

                  <tr v-if="quote.zone_2 != '' && quote.zone_2 != 'null' && quote.zone_2 != null">
                    <td class="bold">Zone 2</td>
                    <td>{{quote.zone_2}}</td>
                  </tr>

                  <tr v-if="quote.zone_3 != '' && quote.zone_3 != 'null' && quote.zone_3 != null">
                    <td class="bold">Zone 3</td>
                    <td>{{quote.zone_3}}</td>
                  </tr>

                  <tr v-if="quote.zone_4 != '' && quote.zone_4 != 'null' && quote.zone_4 != null">
                    <td class="bold">Zone 4</td>
                    <td>{{quote.zone_4}}</td>
                  </tr>

                  <tr v-if="quote.zone_5 != '' && quote.zone_5 != 'null' && quote.zone_5 != null">
                    <td class="bold">Zone 5</td>
                    <td>{{quote.zone_5}}</td>
                  </tr>

                  <tr v-if="quote.zone_6 != '' && quote.zone_6 != 'null' && quote.zone_6 != null">
                    <td class="bold">Zone 6</td>
                    <td>{{quote.zone_6}}</td>
                  </tr>

                  <tr v-if="quote.zone_7 != '' && quote.zone_7 != 'null' && quote.zone_7 != null">
                    <td class="bold">Zone 7</td>
                    <td>{{quote.zone_7}}</td>
                  </tr>

                  <tr v-if="quote.zone_8 != '' && quote.zone_8 != 'null' && quote.zone_8 != null">
                    <td class="bold">Zone 8</td>
                    <td>{{quote.zone_8}}</td>
                  </tr>

                  <tr v-if="quote.zone_9 != '' && quote.zone_9 != 'null' && quote.zone_9 != null">
                    <td class="bold">Zone 9</td>
                    <td>{{quote.zone_9}}</td>
                  </tr>

                  <tr v-if="quote.zone_10 != '' && quote.zone_10 != 'null' && quote.zone_10 != null">
                    <td class="bold">Zone 10</td>
                    <td>{{quote.zone_10}}</td>
                  </tr>

                  <tr v-if="quote.zone_11 != '' && quote.zone_11 != 'null' && quote.zone_11 != null">
                    <td class="bold">Zone 11</td>
                    <td>{{quote.zone_11}}</td>
                  </tr>

                  <tr v-if="quote.zone_12 != '' && quote.zone_12 != 'null' && quote.zone_12 != null">
                    <td class="bold">Zone 12</td>
                    <td>{{quote.zone_12}}</td>
                  </tr>

                  <tr v-if="quote.zone_13 != '' && quote.zone_13 != 'null' && quote.zone_13 != null">
                    <td class="bold">Zone 13</td>
                    <td>{{quote.zone_13}}</td>
                  </tr>

                  <tr v-if="quote.zone_14 != '' && quote.zone_14 != 'null' && quote.zone_14 != null">
                    <td class="bold">Zone 14</td>
                    <td>{{quote.zone_14}}</td>
                  </tr>

                  <tr v-if="quote.zone_15 != '' && quote.zone_15 != 'null' && quote.zone_15 != null">
                    <td class="bold">Zone 15</td>
                    <td>{{quote.zone_15}}</td>
                  </tr>

                  <tr v-if="quote.zone_16 != '' && quote.zone_16 != 'null' && quote.zone_16 != null">
                    <td class="bold">Zone 16</td>
                    <td>{{quote.zone_16}}</td>
                  </tr>
