            ...
            <b-card>
              <b-row>
                ...
                <b-col md="8">
                 ...
                 <!-- zone 1 -->
                 <b-col md="4" v-if="quote.is_custom == 'yes'">
                    <b-form-group label="Zone 1">
                      <b-form-input
                        label="Zone 1"
                        v-model="quote.zone_1"
                      ></b-form-input>
                    </b-form-group>
                </b-col>
                 ...
                 <!-- zone 2 -->
                 <b-col md="4" v-if="quote.is_custom == 'yes'">
                    <b-form-group label="Zone 2">
                      <b-form-input
                        label="Zone 2"
                        v-model="quote.zone_2"
                      ></b-form-input>
                    </b-form-group>
                </b-col>
                 ...
                 <!-- zone 3 -->
                 <b-col md="4" v-if="quote.is_custom == 'yes'">
                    <b-form-group label="Zone 3">
                      <b-form-input
                        label="Zone 3"
                        v-model="quote.zone_3"
                      ></b-form-input>
                    </b-form-group>
                </b-col>
                 ...
                 <!-- zone 4 -->
                 <b-col md="4" v-if="quote.is_custom == 'yes'">
                    <b-form-group label="Zone 4">
                      <b-form-input
                        label="Zone 4"
                        v-model="quote.zone_4"
                      ></b-form-input>
                    </b-form-group>
                </b-col>
                 ...
                 <!-- zone 5 -->
                 <b-col md="4" v-if="quote.is_custom == 'yes'">
                    <b-form-group label="Zone 5">
                      <b-form-input
                        label="Zone 5"
                        v-model="quote.zone_5"
                      ></b-form-input>
                    </b-form-group>
                </b-col>
                 ...
                 <!-- zone 6 -->
                 <b-col md="4" v-if="quote.is_custom == 'yes'">
                    <b-form-group label="Zone 6">
                      <b-form-input
                        label="Zone 6"
                        v-model="quote.zone_6"
                      ></b-form-input>
                    </b-form-group>
                </b-col>
                 ...
                 <!-- zone 7 -->
                 <b-col md="4" v-if="quote.is_custom == 'yes'">
                    <b-form-group label="Zone 7">
                      <b-form-input
                        label="Zone 7"
                        v-model="quote.zone_7"
                      ></b-form-input>
                    </b-form-group>
                </b-col>
                 ...
                 <!-- zone 8 -->
                 <b-col md="4" v-if="quote.is_custom == 'yes'">
                    <b-form-group label="Zone 8">
                      <b-form-input
                        label="Zone 8"
                        v-model="quote.zone_8"
                      ></b-form-input>
                    </b-form-group>
                </b-col>
                 ...
                 <!-- zone 9 -->
                 <b-col md="4" v-if="quote.is_custom == 'yes'">
                    <b-form-group label="Zone 9">
                      <b-form-input
                        label="Zone 9"
                        v-model="quote.zone_9"
                      ></b-form-input>
                    </b-form-group>
                </b-col>
                 ...
                 <!-- zone 10 -->
                 <b-col md="4" v-if="quote.is_custom == 'yes'">
                    <b-form-group label="Zone 10">
                      <b-form-input
                        label="Zone 10"
                        v-model="quote.zone_10"
                      ></b-form-input>
                    </b-form-group>
                </b-col>
                 ...
                 <!-- zone 11 -->
                 <b-col md="4" v-if="quote.is_custom == 'yes'">
                    <b-form-group label="Zone 11">
                      <b-form-input
                        label="Zone 11"
                        v-model="quote.zone_11"
                      ></b-form-input>
                    </b-form-group>
                </b-col>
                 ...
                 <!-- zone 12 -->
                 <b-col md="4" v-if="quote.is_custom == 'yes'">
                    <b-form-group label="Zone 12">
                      <b-form-input
                        label="Zone 12"
                        v-model="quote.zone_12"
                      ></b-form-input>
                    </b-form-group>
                </b-col>
                 ...
                 <!-- zone 13 -->
                 <b-col md="4" v-if="quote.is_custom == 'yes'">
                    <b-form-group label="Zone 13">
                      <b-form-input
                        label="Zone 13"
                        v-model="quote.zone_13"
                      ></b-form-input>
                    </b-form-group>
                </b-col>
                 ...
                 <!-- zone 14 -->
                 <b-col md="4" v-if="quote.is_custom == 'yes'">
                    <b-form-group label="Zone 14">
                      <b-form-input
                        label="Zone 14"
                        v-model="quote.zone_14"
                      ></b-form-input>
                    </b-form-group>
                </b-col>
                 ...
                 <!-- zone 15 -->
                 <b-col md="4" v-if="quote.is_custom == 'yes'">
                    <b-form-group label="Zone 15">
                      <b-form-input
                        label="Zone 15"
                        v-model="quote.zone_15"
                      ></b-form-input>
                    </b-form-group>
                </b-col>
                 ...
                 <!-- zone 16 -->
                 <b-col md="4" v-if="quote.is_custom == 'yes'">
                    <b-form-group label="Zone 16">
                      <b-form-input
                        label="Zone 16"
                        v-model="quote.zone_16"
                      ></b-form-input>
                    </b-form-group>
                </b-col>
  ...
  methods: {
   ...
   // Search Products
    ...
    Verified_Qty(detail, id) {
      for (var i = 0; i < this.details.length; i++) {
        if (this.details[i].detail_id === id) {
          ...
          if (this.quotation_with_stock && detail.etat == "new" && detail.quantity > detail.stock) {
    ...
    increment(detail, id) {
      for (var i = 0; i < this.details.length; i++) {
        if (this.details[i].detail_id == id) {
          if (this.quotation_with_stock && detail.etat == "new" && detail.quantity + 1 > detail.stock) {
            this.makeToast("warning", this.$t("LowStock"), this.$t("Warning"));
          } else if (
            detail.etat == "current" &&
      ...
      if (this.verifiedForm()) {
        ...
        axios
          .put(`quotations/${id}`, {
            ...
            zone_1: this.quote.zone_1,
            zone_2: this.quote.zone_2,
            zone_3: this.quote.zone_3,
            zone_4: this.quote.zone_4,
            zone_5: this.quote.zone_5,
            zone_6: this.quote.zone_6,
            zone_7: this.quote.zone_7,
            zone_8: this.quote.zone_8,
            zone_9: this.quote.zone_9,
            zone_10: this.quote.zone_10,
            zone_11: this.quote.zone_11,
            zone_12: this.quote.zone_12,
            zone_13: this.quote.zone_13,
            zone_14: this.quote.zone_14,
            zone_15: this.quote.zone_15,
            zone_16: this.quote.zone_16,
          })
          .then(response => {
