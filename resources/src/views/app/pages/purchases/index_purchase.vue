    ...
    <div v-else>
      ...
      >
        ...
        <div slot="table-actions" class="mt-2 mb-3">
            <b-button @click="Purchase_PDF()" size="sm" variant="outline-info ripple m-1" class="btn-sm btn btn-primary ripple btn-icon m-1">
            <i class="i-File-Copy"></i> Print Barcode
          </b-button>
