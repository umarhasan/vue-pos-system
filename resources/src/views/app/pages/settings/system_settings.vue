          ...
          <b-col lg="12" md="12" sm="12">
            <b-card no-body :header="$t('SystemSettings')">
              <b-card-body>
                ...
                <b-col md="4" class="mt-4 mb-4">
                    <label class="checkbox checkbox-primary mb-3"><input type="checkbox" v-model="setting.show_product_name"><h5>Display Product Name in Barcode </h5><span class="checkmark"></span></label>
                </b-col>
...
export default {
  ...
  methods: {
    ...
    Update_Settings() {
      ...
      self.data.append("show_product_name", self.setting.show_product_name);
